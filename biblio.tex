...
\bibitem{PETROV10} А. Петров, Разработка и реализация модифицированной подсистемы байес-анализа в системе SpamAssassin, Курсовая работа, МГУ, 2010
\bibitem{ROZ} А. Розинкин, Система защиты от массовых несанкционированных рассылок электронной почты на основе методов DATA MINING, Диссертация на соискание ученой степени кандидата физико-математических наук, МГУ 2006
\bibitem{TOKS} Stevan Bajić, Тоkenizers in dspam, Dspam official documentation [HTML] http://sourceforge.net/apps/mediawiki/dspam/index.php?title=Tokenizers
\bibitem{LIBSVM}Оффициальная страница libsvm, [HTML] http://www.csie.ntu.edu.tw/~cjlin/libsvm/
\bibitem{VORONCOV} К. В. Воронцов, Курс лекций по машинному обучению, [PDF] http://bit.ly/voroncov\_ml 
\bibitem{SVN} C. Cortes, V. Vapnik, Support-Vector Networks, Machine Learning, 20, 1995 [HTML] http://www.springerlink.com/content/k238jx04hm87j80g/
\bibitem{TUTIN}Сергей Тютин, "Сколько слов в русском языке". [HTML] http://linguistics-msu.livejournal.com/10968.html?thread=13784\#t13784
\end{thebibliography}
